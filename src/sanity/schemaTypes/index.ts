...
export const schema: { types: SchemaTypeDefinition[] } = {
  types: [blockContentType, contentSegmentType, footerContactSettingsType, footerLinksSettingsType, homepageSettingsType, pagePageSectionType, postType, pageType, typefacePageSectionType, typefaceType, siteSettingsType],
};
